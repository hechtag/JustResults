...
public static class ResultCurryMapExtensions
{
    public static Result<Func<TInput2, TOutput>> Map<TInput1, TInput2, TOutput>(this Result<TInput1> input,
        Func<TInput1, TInput2, TOutput> mapFunc) where TInput1 : notnull =>
    ...
    public static Result<Func<TInput2, TInput3, TOutput>> Map<TInput1, TInput2, TInput3, TOutput>(
        ...
        Func<TInput1, TInput2, TInput3, TOutput> mapFunc) where TInput1 : notnull =>
    ...
    public static Result<Func<TInput2, TInput3, TInput4, TOutput>> Map<TInput1, TInput2, TInput3, TInput4, TOutput>(
        this Result<TInput1> input,
        Func<TInput1, TInput2, TInput3, TInput4, TOutput> mapFunc) where TInput1 : notnull =>
        input.Match(
            i1 => Result<Func<TInput2, TInput3, TInput4, TOutput>>.Success((i2, i3, i4) => mapFunc(i1, i2, i3, i4)),
