...
{
    public static Result<TSuccess> Flatten<TSuccess>(this Result<Result<TSuccess>> input) where TSuccess : notnull
    ...
    public static Task<Result<TSuccess>> FlattenAsync<TSuccess>(this Task<Result<Result<TSuccess>>> input) where TSuccess : notnull
