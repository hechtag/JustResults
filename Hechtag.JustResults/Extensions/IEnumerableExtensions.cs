...
{
    public static IEnumerable<TSuccess> WhereSuccess<TSuccess>(this IEnumerable<Result<TSuccess>> input) where TSuccess : notnull
        => input
            .Where(r => r.IsSuccess)
            .Select(r => r.GetValue()!);

    public static Task<IEnumerable<TSuccess>> WhereSuccessAsync<TSuccess>(this Task<IEnumerable<Result<TSuccess>>> input) where TSuccess : notnull
        => input.MapTask(i => i.WhereSuccess());

    public static IEnumerable<IError> WhereFailure<TSuccess>(this IEnumerable<Result<TSuccess>> input) where TSuccess : notnull
        => input
            .Where(r => !r.IsSuccess)
            .Select(r => r.GetError()!);

    public static Task<IEnumerable<IError>> WhereFailureAsync<TSuccess>(this Task<IEnumerable<Result<TSuccess>>> input) where TSuccess : notnull
        => input.MapTask(i => i.WhereFailure());

    public static Result<IEnumerable<TSuccess>> SequenceApply<TSuccess>(this IEnumerable<Result<TSuccess>> input) where TSuccess : notnull
    {
    ...
    public static Result<IEnumerable<TSuccess>> SequenceBind<TSuccess>(this IEnumerable<Result<TSuccess>> input) where TSuccess : notnull
    {
        var start = Result<IEnumerable<TSuccess>>.Success(new List<TSuccess>());
    ...
    public static Result<IEnumerable<TOutput>> TraverseApply<TInput, TOutput>(
        ...
        Func<TInput, Result<TOutput>> func) where TOutput : notnull
    {
